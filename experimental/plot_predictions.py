...
ax.scatter(gcarcs, arrivals, 5, color='gainsboro')
...
# 0 Km Event
ax.plot(x, prem_410_0(x), color='blue', label='PREM 0 km')
ax.plot(x, iasp_410_0(x), color='green', label='IASP 0 km')
ax.plot(x, prem_660_0(x), color='blue')
ax.plot(x, iasp_660_0(x), color='green')

# 70 Km Event
ax.plot(x, prem_410_70(x), '--', color='blue', label='PREM 70 km')
ax.plot(x, iasp_410_70(x), '--', color='green', label='IASP 70 km')
ax.plot(x, prem_660_70(x), '--', color='blue')
ax.plot(x, iasp_660_70(x), '--', color='green')
...
fig.savefig('/home/jorgeagr/Downloads/sds_tdiff_epidist.png')