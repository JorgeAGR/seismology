...
polarity_model = polarity_pred.init_Polarity_Model(config_dic['train_dir'], 
                                                  config_dic['seismos_train'],
                                                  config_dic['polarities_train'],
                                                  config_dic['batch_size'],  
                                                  config_dic['epochs'],
                                                  config_dic['model_iters'])

polarity_model.save('./models/polarity_prediction_model.h5')
