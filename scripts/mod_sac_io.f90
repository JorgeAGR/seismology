...
!***********************************************************************
! Initialize all values as undefined

! Get all those reals undefined
!     delta=rundef; depmin=rundef; depmax=rundef; scale=rundef; odelta=rundef
!     b=rundef; e=rundef; o=rundef; a=rundef; internal1=rundef
!     t0=rundef; t1=rundef; t2=rundef; t3=rundef; t4=rundef
!     t5=rundef; t6=rundef; t7=rundef; t8=rundef; t9=rundef
!     f=rundef; resp0=rundef; resp1=rundef; resp2=rundef; resp3=rundef
!     resp4=rundef; resp5=rundef; resp6=rundef; resp7=rundef; resp8=rundef
!     resp9=rundef; stla=rundef; stlo=rundef; stel=rundef; stdp=rundef
!     evla=rundef; evlo=rundef; evel=rundef; evdp=rundef; mag=rundef
!     user0=rundef; user1=rundef; user2=rundef; user3=rundef; user4=rundef
!     user5=rundef; user6=rundef; user7=rundef; user8=rundef; user9=rundef
!     dist=rundef; az=rundef; baz=rundef; gcarc=rundef; internal2=rundef
!     internal3=rundef; depmen=rundef; cmpaz=rundef; cmpinc=rundef; xminimum=rundef
!     xmaximum=rundef; yminimum=rundef; ymaximum=rundef; unused1=rundef; unused2=rundef
!     unused3=rundef; unused4=rundef; unused5=rundef; unused6=rundef; unused7=rundef

! Undefine the integers
!     nzyear=iundef; nzjday=iundef; nzhour=iundef; nzmin=iundef; nzsec=iundef
!     nzmsec=iundef; nvhdr=iundef; norid=iundef; nevid=iundef; npts=iundef
!     internal4=iundef; nwfid=iundef; nxsize=iundef; nysize=iundef; unused8=iundef
!     iftype=iundef; idep=iundef; iztype=iundef; unused9=iundef; iinst=iundef
!     istreg=iundef; ievreg=iundef; ievtyp=iundef; iqual=iundef; isynth=iundef
!     imagtyp=iundef; imagsrc=iundef; unused10=iundef; unused11=iundef; unused12=iundef
!     unused13=iundef; unused14=iundef; unused15=iundef; unused16=iundef; unused17=iundef

! Undefine the logicals
!     leven=lfalse; lpspol=lfalse; lovrok=lfalse; lcalda=lfalse; unused18=lfalse

! Undefine the characters
!     kevnm=kundef
!     kstnm=kundef
!     khole=kundef; ko=kundef; ka=kundef
!     kt0=kundef; kt1=kundef; kt2=kundef
!     kt3=kundef; kt4=kundef; kt5=kundef 
!     kt6=kundef; kt7=kundef; kt8=kundef
!     kt9=kundef; kf=kundef; kuser0=kundef
!     kuser1=kundef; kuser2=kundef; kcmpnm=kundef
!     knetwk=kundef; kdatrd=kundef; kinst=kundef
